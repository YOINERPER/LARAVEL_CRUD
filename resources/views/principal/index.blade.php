...
@section('main')
    ...
    <div class="w-60 h-2/4  bg-[#42BCE5] rounded-lg mx-5">
    ...
    <div class="w-60 h-2/4 bg-[#475569] rounded-lg mx-5">
        <h4 class="text-lg font-semibold text-white dark:text-slate-900 text-center w-64 bg-[#0089A6]  -left-2 relative z-10">CLIENTS ADMIN</h4>
        <div class="w-full h-4/5 bg-slate-600 ">
            <a href="{{url('users')}}">
